...
const CATALOG: ModuleMeta[] = [
  ...
  { i: 4, icon: "💰", category: "economia", status: "ready", plans: [L, L, Y], key: "inmuebles" },
  { i: 5, icon: "📞", category: "seguridad", status: "ready", plans: [Y, Y, Y], key: "citofonia" },
  { i: 6, icon: "👥", category: "admin", status: "ready", plans: [N, Y, Y], key: "familiares" },
  { i: 7, icon: "📢", category: "comunicacion", status: "ready", plans: [L, L, Y], key: "comunciaciones" },
  { i: 10, icon: "📝", category: "admin", status: "ready", plans: [Y, Y, Y], key: "registroInterno" },
  { i: 11, icon: "📰", category: "comunicacion", status: "ready", plans: [L, L, Y], key: "cartelera" },
  { i: 12, icon: "🛒", category: "economia", status: "ready", plans: [N, N, Y], key: "productos" },
  { i: 13, icon: "📊", category: "admin", status: "ready", plans: [L, Y, Y], key: "balance" },
  { i: 14, icon: "🗣️", category: "comunidad", status: "ready", plans: [L, L, Y], key: "foro" },
  { i: 15, icon: "📂", category: "admin", status: "ready", plans: [L, L, Y], key: "documentos" },
  { i: 16, icon: "🛠️", category: "admin", status: "ready", plans: [N, Y, Y], key: "mantenimientos" },
  { i: 17, icon: "🗳️", category: "admin", status: "ready", plans: [N, Y, Y], key: "asambleas" },
  { i: 18, icon: "🏨", category: "economia", status: "ready", plans: [Y, Y, Y], key: "registroExtermo" },
  { i: 19, icon: "🤖", category: "ia", status: "ready", plans: [L, L, Y], key: "agente" },
  { i: 20, icon: "🏪", category: "economia", status: "ready", plans: [N, N, Y], key: "productos" },
  { i: 21, icon: "🤝", category: "economia", status: "ready", plans: [N, N, Y], key: "alianzas" },
  { i: 25, icon: "🏊", category: "comunidad", status: "ready", plans: [Y, Y, Y], key: "social" },
  { i: 26, icon: "🧾", category: "admin", status: "ready", plans: [Y, Y, Y], key: "pazsalvos" },
  { i: 27, icon: "📮", category: "comunicacion", status: "ready", plans: [Y, Y, Y], key: "pqr" },
  { i: 32, icon: "💵", category: "admin", status: "ready", plans: [Y, Y, Y], key: "gastos" },
  { i: 33, icon: "💳", category: "admin", status: "ready", plans: [Y, Y, Y], key: "pagos" },
  { i: 34, icon: "🏬", category: "economia", status: "ready", plans: [N, N, N], key: "locales" },
  { i: 35, icon: "🔑", category: "economia", status: "ready", plans: [N, N, N], key: "locales" },
  { i: 38, icon: "🧑‍🔧", category: "admin", status: "ready", plans: [Y, Y, Y], key: "colaboradores" },
  { i: 39, icon: "🎫", category: "economia", status: "ready", plans: [N, N, Y], key: "alianzas" },

  // ── Sin dato en `plans_features`: supuesto pendiente de confirmar ──────
  { i: 0, icon: "🔒", category: "seguridad", status: "ready", plans: [Y, Y, Y], key: null },
  { i: 1, icon: "💬", category: "comunicacion", status: "ready", plans: [Y, Y, Y], key: null },
  { i: 2, icon: "🏘️", category: "comunidad", status: "ready", plans: [Y, Y, Y], key: null },
  { i: 3, icon: "🏖️", category: "economia", status: "ready", plans: [Y, Y, Y], key: null },
  { i: 8, icon: "📅", category: "comunidad", status: "ready", plans: [Y, Y, Y], key: null },
  { i: 9, icon: "🚪", category: "seguridad", status: "ready", plans: [Y, Y, Y], key: null },
  { i: 22, icon: "🛵", category: "seguridad", status: "ready", plans: [N, N, Y], key: null },
  { i: 23, icon: "🎟️", category: "seguridad", status: "ready", plans: [Y, Y, Y], key: null },
  { i: 29, icon: "🏛️", category: "admin", status: "ready", plans: [Y, Y, Y], key: null },
  { i: 30, icon: "🚨", category: "seguridad", status: "ready", plans: [Y, Y, Y], key: null },
  { i: 31, icon: "📄", category: "admin", status: "ready", plans: [Y, Y, Y], key: null },
  { i: 36, icon: "🎁", category: "economia", status: "ready", plans: [Y, Y, Y], key: null },
  ...
  { i: 41, icon: "⚖️", category: "admin", status: "ready", plans: [Y, Y, Y], key: null },

  // ── En desarrollo: sin plan asignado todavía ──────────────────────────
  { i: 24, icon: "📹", category: "seguridad", status: "dev", plans: [N, N, N], key: null },
  { i: 28, icon: "✍️", category: "admin", status: "dev", plans: [N, N, N], key: null },
  { i: 37, icon: "🔄", category: "comunidad", status: "dev", plans: [N, N, N], key: null },
  ...
  { i: 40, icon: "🅿️", category: "seguridad", status: "dev", plans: [N, N, N], key: null },
];
